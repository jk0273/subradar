    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Crée ton compte gratuit</h1>
          <p className="text-slate-500 text-sm mt-1">Premier scan gratuit. Aucune carte requise.</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <button onClick={handleGoogleRegister} disabled={loading} className="btn-secondary w-full justify-center mb-6 gap-3">
            ...
            <div>
              ...
              {password && (
                <div className={`mt-1.5 text-xs flex items-center gap-1 ${passwordStrong ? "text-green-600" : "text-slate-400"}`}>
                  ...
                  {passwordStrong ? "Mot de passe fort" : "8 caractères min, 1 majuscule, 1 chiffre"}
                </div>
              )}
            </div>
